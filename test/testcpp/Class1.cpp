...
ITR_DEFINE_STATIC_LOGGER(NS1.Class1Static);
...
void Class1::foo1()
{
  ...
  cout << "Enabled MAXDETAIL Class1 = " << (ITR_ENABLED_MAXDETAIL() ? "True" : "False") << endl;
  ...
  ITR_LOG_MAXDETAIL_FORCED("Test log");
  ITR_LOG_DETAIL("NS1.Class1Cust", "Test log");
  ITR_LOG_DETAIL("NS1.Class1Cust", "Test log with integer : " << 1);
...
void Class1::foo2()
{
  ...
  ITR_DEFINE_FUNCTION_LOGGER(NS1.Class1Func);
